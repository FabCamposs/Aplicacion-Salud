...
namespace AplicacionTienda.ServicioWebSalud {
    using System;
    ...
    [System.Web.Services.WebServiceBindingAttribute(Name="ServicioWebSaludSoap", Namespace="http://tempuri.org/")]
    public partial class ServicioWebSalud : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        /// <remarks/>
        public ServicioWebSalud() {
            this.Url = "http://192.168.0.11:82/ServicioWebSalud.asmx";
        ...
        public bool Guardar(string Nombre, string Domicilio, string Correo, string Fecha, int Hora) {
        ...
        /// <remarks/>
        public void GuardarAsync(string Nombre, string Domicilio, string Correo, string Fecha, int Hora) {
            this.GuardarAsync(Nombre, Domicilio, Correo, Fecha, Hora, null);
        }
        
        /// <remarks/>
        public void GuardarAsync(string Nombre, string Domicilio, string Correo, string Fecha, int Hora, object userState) {
            ...
            this.InvokeAsync("Guardar", new object[] {
                        ...
                        Correo,
                        Fecha,
                        Hora}, this.GuardarOperationCompleted, userState);
        }
        ...
        public System.Data.DataSet Busqueda(string Nombre) {
        ...
        /// <remarks/>
        public void BusquedaAsync(string Nombre) {
            this.BusquedaAsync(Nombre, null);
        }
        
        /// <remarks/>
        public void BusquedaAsync(string Nombre, object userState) {
            ...
            this.InvokeAsync("Busqueda", new object[] {
                        Nombre}, this.BusquedaOperationCompleted, userState);
        }
